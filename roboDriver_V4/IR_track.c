...
#define LINE_THRESHOLD 2800   // ADC threshold for black detection - aligned with 3200 center
...
bool is_line_traced() {
    ...
    return (line_adc_value >= LINE_THRESHOLD); // ret TRUE if black, FALSE if white
}

// Function to get raw ADC value for debugging
uint16_t get_line_adc_value() {
    return line_adc_value;
}
